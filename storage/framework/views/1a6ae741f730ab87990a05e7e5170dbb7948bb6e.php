...
<html lang="en">
    ...
    <body class="sb-nav-fixed">
        <nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
            <!-- Navbar Brand-->
            <a class="navbar-brand ps-3" href="<?php echo e(route('admin.home')); ?>"><?php echo $__env->yieldContent('pageName'); ?></a>
            <!-- Sidebar Toggle-->
            ...
            <ul class="d-none d-md-inline-block form-inline ms-auto me-0 me-md-3 my-2 my-md-0">
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdown">
                        <li><a class="dropdown-item" href="<?php echo e(route('admins.logout')); ?>">Logout</a></li>
                    </ul>
                </li>
            </ul>
        </nav>
                                ...
                                <nav class="sb-sidenav-menu-nested nav accordion" id="sidenavAccordionPages">
                                    ...
                                    <div class="collapse" id="pagesCollapseAuth" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordionPages">
                                        <nav class="sb-sidenav-menu-nested nav">
                                            ...
                                            <a class="nav-link" href="<?php echo e(route('admin.search.students.form')); ?>">Search students</a>
                                            <a class="nav-link" href="<?php echo e(route('admin.new.students')); ?>">New students</a>
                                        </nav>
                                    </div>
                                    ...
                                    <div class="collapse" id="pagesCollapseError" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordionPages">
                                        <nav class="sb-sidenav-menu-nested nav">
                                            ...
                                            <a class="nav-link" href="<?php echo e(route('admin.search.instructors.form')); ?>">Search Instructions</a>
                                            <a class="nav-link" href="<?php echo e(route('admin.new.instructors')); ?>">New Instructors</a>
                                        </nav>
                                    </div>
                                </nav>
                            </div>
...
<?php /**PATH /home/lilbig/Desktop/project/laravel/resources/views/layouts/dashboard/admin.blade.php ENDPATH**/ ?>