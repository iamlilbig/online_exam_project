                        ...
                        @foreach($unreadNotifications as $notification)
                            <div class="alert alert-info">
                                ...
                                <div class="btn-group" role="group" aria-label="Basic mixed styles example">
                                    <a href="{{route('instructors.notifications.read',['id'=>$notification->id])}}" class="btn btn-success">Mark as read</a>
                                    <a href="{{route('instructors.notifications.delete',['id'=>$notification->id])}}" class="btn btn-outline-danger">Delete</a>
                                </div>
                            </div>
                        @endforeach
