...
<html lang="en">
    ...
    <body class="sb-nav-fixed">
        <nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
            <!-- Navbar Brand-->
            <div class="navbar-brand ps-3" id="timer"></div>
            <!-- Sidebar Toggle-->
        ...
        <script src="https://cdn.jsdelivr.net/npm/simple-datatables@latest" crossorigin="anonymous"></script>
                ...
                var countDownDate = new Date("{{$exam->results->where('student_id',Auth::user()->id)->first()->ended_at}}").getTime();
                ...
                var x = setInterval(function() {
                  ...
                  document.getElementById("timer").innerHTML = "Times remaining: <br>" + hours + "h "
                  + minutes + "m " + seconds + "s ";

                  // If the count down is over, write some text
                  if (distance < 0) {
                    clearInterval(x);
                    document.getElementById("timer").innerHTML = "<div>Your time is over</div>";
                  }
                }, 1000);
                </script>
