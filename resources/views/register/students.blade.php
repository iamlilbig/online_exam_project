@extends('layouts.app')
 ...
 <div class="form-floating mb-3">
        ...
        @endif
    <form action="{{route('register.students.store')}}" method="post">
        @csrf
            <div class="form-floating mb-3">
     ...
     <a href="{{route('login.students') }}" class="link-secondary">you have an account?</a>
     <div class="btn-group">
         <a href="{{ route('register.students') }}" class="btn btn-primary active">students</a>
         <a href="{{ route('register.instructors') }}" class="btn btn-outline-primary" aria-current="page">instructors</a>
     </div>
 </div>
 @endsection
@section('pageName')
